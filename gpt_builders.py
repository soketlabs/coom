...
from coom.training import get_args, print_rank_0
from coom.training.arguments import core_transformer_config_from_args
from coom.training.yaml_arguments import core_transformer_config_from_yaml
...
def gpt_builder(args, pre_process, post_process, vp_stage=None, config=None):
    ...
    if args.use_legacy_models:
        from coom.legacy.model import GPTModel as LegacyGPTModel
